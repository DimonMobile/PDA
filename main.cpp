...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        Fst fst = {
/* 0 */             Fst::Vertex( _(1, Edge::create(L'@')), _(15, Edge::create(L'б')), _(20, Edge::create(L'в')), _(27, Edge::create(L'д')), _(34, Edge::create(L'к')), _(39, Edge::create(L'л')), _(47, Edge::create(L'п')) )
...
/*70 */         ,   Fst::Vertex().setAction([](){std::wcout << L"пуста detected" << std::endl;})
        ...
        std::wcout << "***FinalStepTranducer: " << fst.execute(L"пуста") << std::endl;
    }
