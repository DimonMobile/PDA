...
/* 6 */         ,   Fst::Vertex().setAction([](){std::wcout << L"@нумар detected" << std::endl;})
...
/*14 */         ,   Fst::Vertex().setAction([](){std::wcout << L"@уключыць detected" << std::endl;})
...
/*19 */         ,   Fst::Vertex().setAction([](){std::wcout << L"будзе detected" << std::endl;})
...
/*26 */         ,   Fst::Vertex().setAction([](){std::wcout << L"вярнуць detected" << std::endl;})
...
/*33 */         ,   Fst::Vertex().setAction([](){std::wcout << L"дробнае detected" << std::endl;})
...
/*38 */         ,   Fst::Vertex().setAction([](){std::wcout << L"канец detected" << std::endl;})
...
/*46 */         ,   Fst::Vertex().setAction([](){std::wcout << L"лагичнае detected" << std::endl;})
...
/*52 */         ,   Fst::Vertex().setAction([](){std::wcout << L"пакажы detected" << std::endl;})
/*53 */         ,   Fst::Vertex( _(54, Edge::create(L'л')) )
/*54 */         ,   Fst::Vertex( _(55, Edge::create(L'ь')) )
/*55 */         ,   Fst::Vertex().setAction([](){std::wcout << L"пакуль detected" << std::endl;})
...
/*61 */         ,   Fst::Vertex().setAction([](){std::wcout << L"паламаць detected" << std::endl;})
...
/*66 */         ,   Fst::Vertex().setAction([](){std::wcout << L"пачатак detected" << std::endl;})
/*67 */         ,   Fst::Vertex( _(68, Edge::create(L'с')) )
/*68 */         ,   Fst::Vertex( _(69, Edge::create(L'т')) )
/*69 */         ,   Fst::Vertex( _(70, Edge::create(L'а')) )
/*70 */         ,   Fst::Vertex().setAction([](){std::wcout << L"пуста detected" << std::endl;})
...
/*75 */         ,   Fst::Vertex().setAction([](){std::wcout << L"радок detected" << std::endl;})
...
/*81 */         ,   Fst::Vertex().setAction([](){std::wcout << L"спытай detected" << std::endl;})
...
/*89 */         ,   Fst::Vertex().setAction([](){std::wcout << L"стварыць detected" << std::endl;})
...
/*94 */         ,   Fst::Vertex().setAction([](){std::wcout << L"цэлае detected" << std::endl;})
